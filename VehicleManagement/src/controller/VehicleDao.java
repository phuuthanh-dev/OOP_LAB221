...
public class VehicleDao {
    ...
    public void updateVehicle() {
        ...
        menuUpdateVehicle(vehicleUpdate);
    }

    public void menuUpdateVehicle(Vehicle vehicleUpdate) {
        int choice;
        boolean ok;
        do {
            System.out.println("+---------------------------+");
    ...
    public void showOneVehicle(Vehicle vehicle) {
        if (vehicle == null) {
    ...
    public void deleteVehicle() {
        ...
        if (vehicleDelete == null) {
            System.out.println("Vehicle not found!!, Delete fail!!!");
            return;
        }
    ...
    public void searchVehicleByName() {
        ...
        for (int i = 0; i < listVehicleSearch.size() - 1; i++) {
            for (int j = i + 1; j < listVehicleSearch.size(); j++) {
                if (listVehicleSearch.get(i).getNameVehicle().compareTo(listVehicleSearch.get(j).getNameVehicle()) < 0) {
